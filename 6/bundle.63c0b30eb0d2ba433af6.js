...
function generatePointMock(type, destinationId, offerIds) {
  return {
    id: pointId(),
    base_price: (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.getRandomFromRange)(_const_js__WEBPACK_IMPORTED_MODULE_1__.PRICE.min, _const_js__WEBPACK_IMPORTED_MODULE_1__.PRICE.max),
    date_from: (0,_date_mock_js__WEBPACK_IMPORTED_MODULE_2__.getDate)({
      dateTo: false
    }),
    date_to: (0,_date_mock_js__WEBPACK_IMPORTED_MODULE_2__.getDate)({
      dateTo: true
    }),
    destination: destinationId,
    is_favorite: Boolean((0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.getRandomFromRange)(0, 1)),
    offers: [offerIds],
    type
  };
}
...
/* harmony import */ var _view_list_points_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/list-points-view.js */ "./src/view/list-points-view.js");
...
/* harmony import */ var _view_editing_point_view_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/editing-point-view.js */ "./src/view/editing-point-view.js");
/* harmony import */ var _framework_render_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../framework/render.js */ "./src/framework/render.js");
/* harmony import */ var _mock_filter_mock_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../mock/filter-mock.js */ "./src/mock/filter-mock.js");
// views
...
class Presenter {
  #pointListComponent = new _view_list_points_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  ...
  init() {
    const filters = (0,_mock_filter_mock_js__WEBPACK_IMPORTED_MODULE_7__.filteredPoints)();
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_list_filter_view_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.#points, filters), siteFiltersElement);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_info_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](), siteInfoElement, 'afterbegin');
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_list_sort_view_js__WEBPACK_IMPORTED_MODULE_3__["default"](), this.#pointsContainer);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(this.#pointListComponent, this.#pointsContainer);
  ...
  #renderPoint({
    ...
    const pointComponent = new _view_point_view_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
      point,
      pointDestinations,
      pointOffers,
      onEditClick: () => {
    ...
    const pointEditComponent = new _view_editing_point_view_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
      point,
      pointDestinations,
      pointOffers,
      onFormSubmit: () => {
    ...
    function replacePointToForm() {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_6__.replace)(pointEditComponent, pointComponent);
    }
    function replaceFormToPoint() {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_6__.replace)(pointComponent, pointEditComponent);
    }
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(pointComponent, this.#pointListComponent.element);
  }
}
...
const filterFunctions = {
  ...
  [_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterTypes.PRESENT]: points => points.filter(point => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.date_to)) && dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.date_from))),
  [_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterTypes.PAST]: points => points.filter(point => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.date_to))),
  [_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterTypes.FUTURE]: points => points.filter(point => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.date_from)))
};
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.slashDateHumanize)(date_from)}">
            &mdash;
            <label class="visually-hidden" for="event-end-time-1">To</label>
            <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.slashDateHumanize)(date_to)}">
          </div>
...
function createPointTemplate({
  ...
  return `<li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.datetimeHumanize)(date_from)}">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.shortDateHumanize)(date_from)}</time>
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.datetimeHumanize)(date_from)}">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.timeHumanize)(date_from)}</time>
            &mdash;
            <time class="event__end-time" datetime="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.datetimeHumanize)(date_to)}">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.timeHumanize)(date_to)}</time>
          </p>
          <p class="event__duration">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.durationEvent)(date_from, date_to)}</p>
        </div>
...
/******/ })()
;
//# sourceMappingURL=bundle.63c0b30eb0d2ba433af6.js.map