...
class Presenter {
  ...
  init() {
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_list_sort_view_js__WEBPACK_IMPORTED_MODULE_3__["default"](), this.pointsContainer);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(this.pointListComponent, this.pointsContainer);
    const randomEditingPoint = (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.getRandomArrayElement)(this.points);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_editing_point_view_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    for (let i = 0; i < this.points.length; i++) {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_point_view_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
        point: this.points[i],
...
function createPointTemplate({
  ...
  return `<li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.datetimeHumanize)(date_from)}">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.shortDateHumanize)(date_from)}</time>
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.datetimeHumanize)(date_from)}">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.timeHumanize)(date_from)}</time>
            &mdash;
            <time class="event__end-time" datetime="${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.datetimeHumanize)(date_to)}">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.timeHumanize)(date_to)}</time>
          </p>
          <p class="event__duration">${(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.durationEvent)(date_from, date_to)}</p>
        </div>
...
/******/ })()
;
//# sourceMappingURL=bundle.ff46e8f7caa366545563.js.map